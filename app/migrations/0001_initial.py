...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winter', models.CharField(blank=True, choices=[(None, '--'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2Б', '2Б'), ('3А', '3А'), ('3Б', '3Б')], default=None, max_length=2, null=True)),
                ('summer', models.CharField(blank=True, choices=[(None, '--'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2Б', '2Б'), ('3А', '3А'), ('3Б', '3Б')], default=None, max_length=2, null=True)),
                ('autumn', models.CharField(blank=True, choices=[(None, '--'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2Б', '2Б'), ('3А', '3А'), ('3Б', '3Б')], default=None, max_length=2, null=True)),
                ('spring', models.CharField(blank=True, choices=[(None, '--'), ('1А', '1А'), ('1Б', '1Б'), ('2А', '2А'), ('2Б', '2Б'), ('3А', '3А'), ('3Б', '3Б')], default=None, max_length=2, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
